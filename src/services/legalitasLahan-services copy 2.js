...
const createUpdate = async (user, request) => {
...
const legalitasLahanServices = { create, findAll, confirm, PetakanLahan, publish, findOne, Update, historyLegalitasLahan, createDataKebun, createBaru, createV2, createUpdate};
